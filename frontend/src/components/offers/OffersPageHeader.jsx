      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">
            Find exclusive deals, discounts, and special offers from
        ...
        <div className="mt-8 flex max-w-5xl flex-col gap-3 md:flex-row">
          ...
          {/* Search */}
          <div className="flex min-w-0 flex-1 items-center rounded-xl border border-slate-300 bg-white shadow-sm transition focus-within:border-blue-950 focus-within:ring-2 focus-within:ring-blue-100">
            <Search
              size={20}
