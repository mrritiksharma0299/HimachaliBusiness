...
function TravelTransportTemplate({ business }) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Travel and transportation services available from this
                business.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Convenient transportation options for local travel.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Assistance for planning and arranging travel services.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Contact the provider to discuss your travel requirements.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Connect with a provider familiar with local travel needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Find travel and transport services in the listed location.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Contact the provider directly for bookings and enquiries.
                </p>
              </div>
            </div>
          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Available travel and transport offers.
                </p>
              </div>
            </div>
...
export default TravelTransportTemplate;
