...
function EducationTrainingTemplate({ business }) {
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Learning, education and training opportunities available from
                this business.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Educational programs designed to support learning and skill
                development.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Training opportunities focused on building useful knowledge
                and skills.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Contact the provider to discuss available courses and
                schedules.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Find education and training opportunities available
                  locally.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Connect with providers offering learning and skill-building
                  services.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Contact the institution directly for courses and admission
                  enquiries.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Available education and training offers.
                </p>
              </div>
            </div>
        ...
        {allImages.length === 0 && (
          <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-500">
              This institution has not added any photos yet.
            </p>
          </section>
        )}
      </div>
...
export default EducationTrainingTemplate;