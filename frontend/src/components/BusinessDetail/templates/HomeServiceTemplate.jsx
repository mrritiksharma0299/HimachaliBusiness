...
function HomeServiceTemplate({ business }) {
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Professional services available for your home.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Professional help for improving and maintaining your living
                space.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Convenient service designed around your schedule.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Get help from a local service provider.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Conveniently serving customers in the listed location.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Contact the service provider directly for enquiries.
                </p>
              </div>
            </div>
          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Available offers from this service provider.
                </p>
              </div>
            </div>
...
export default HomeServiceTemplate;