...
function RepairMechanicTemplate({ business }) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Repair and maintenance services offered by this business.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Reliable repair and maintenance solutions for everyday
                mechanical problems.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Inspection and diagnosis to identify problems before repair.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Routine maintenance to help keep vehicles and equipment
                working properly.
              </p>
            </div>
          </div>
...
export default RepairMechanicTemplate;