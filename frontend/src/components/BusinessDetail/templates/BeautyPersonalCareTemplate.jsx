...
function BeautyPersonalCareTemplate({ business }) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Personal care and beauty services available from this
                business.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Hair care, styling and grooming services for your personal
                needs.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Beauty and personal care services designed for your needs.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Convenient grooming and personal care services available
                locally.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Connect with a local beauty and personal care provider.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Find personal care services available in the listed
                  location.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Contact the business directly for appointments and
                  enquiries.
                </p>
              </div>
            </div>
...
export default BeautyPersonalCareTemplate;