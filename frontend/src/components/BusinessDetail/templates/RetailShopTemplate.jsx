...
function RetailShopTemplate({ business }) {
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Discover what this shop has to offer.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Explore products and items available from this local shop.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Shop conveniently from a business serving the local
                community.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Contact the shop directly for product availability and
                enquiries.
              </p>
            </div>
          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Available offers from this shop.
                </p>
              </div>
            </div>
        ...
        {allImages.length === 0 && (
          <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-500">
              This shop has not added any photos yet.
            </p>
          </section>
        )}
      </div>
