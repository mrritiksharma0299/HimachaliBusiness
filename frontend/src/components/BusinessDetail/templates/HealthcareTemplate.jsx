...
function HealthcareTemplate({ business }) {
      ...
      <div className="space-y-6">
            ...
            <div>
              <div className="mb-3 flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-900">
                  <HeartPulse size={14} strokeWidth={1.8} />
                  Healthcare
                </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Healthcare services and support provided by this business.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Professional healthcare consultation and guidance.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Healthcare support focused on patient needs and wellbeing.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Convenient access to local healthcare-related services.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Connect with a local healthcare provider for your needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Find healthcare services available in the listed location.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Contact the provider directly for enquiries and
                  appointments.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Available offers from this healthcare provider.
                </p>
              </div>
            </div>
        ...
        {allImages.length === 0 && (
          <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-500">
              This healthcare provider has not added any photos yet.
            </p>
          </section>
        )}
      </div>
